...
public class SwaggerConfig {
    ...
    public OpenAPI openAPI() {
        return new OpenAPI()
                .info(new Info()
                        .title("CalmSkin Promotion Service API")
                        .version("1.0.0")
                        .description("Vouchers, flash sales and the promotion discount engine")
                ...
                .components(new Components()
                        ...
                        .addSecuritySchemes("Internal Secret",
                                new SecurityScheme()
                                        ...
                                        .description("Secret for internal service-to-service calls")));
    }
}
