package com.lakeserl.promotion_service.filter;
...
/**
 * Layer 2 guard for /internal/** endpoints: rejects any request whose
 * X-Internal-Secret header does not match the configured secret.
 */
@Component
