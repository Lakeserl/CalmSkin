...
/**
 * Stateless security. Webhook endpoints are public (gateways call them
 * server-to-server without a JWT); /internal/** is guarded separately by
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/v1/payments/cod/confirm").hasRole("ADMIN")
