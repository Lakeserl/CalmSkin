...
public class SwaggerConfig {
    ...
    public OpenAPI openAPI() {
        return new OpenAPI()
                .info(new Info()
                        .title("CalmSkin Product Service API")
                        .version("1.0.0")
                        .description("Product catalog, categories, brands, and ingredients management APIs")
                ...
                .components(new Components()
                        .addSecuritySchemes("Bearer Auth",
                                new SecurityScheme()
                                        ...
                                        .scheme("bearer")
                                        .bearerFormat("JWT")
                                        .description("Enter your JWT access token (for admin APIs)"))
